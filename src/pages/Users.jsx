...
import { Search, Plus, Edit3, Trash2, KeyRound, Eye, EyeOff } from "lucide-react";
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setNewUser({ ...newUser, fullName: e.target.value.replace(/\b\w/g, char => char.toUpperCase()) })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:outline-none"
              />
            </div>
            <div>
